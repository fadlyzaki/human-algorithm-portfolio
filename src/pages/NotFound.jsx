...
const NotFound = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col font-mono selection:bg-[var(--accent-error)] selection:text-white bg-[var(--bg-void)] transition-colors duration-500"
      style={themeStyles}
    >
        ...
        <div className="max-w-2xl w-full border border-[var(--accent-error)]/30 bg-[var(--bg-void)] p-8 md:p-12 relative shadow-[0_0_50px_rgba(239,68,68,0.1)] z-10">
          ...
          <div className="font-mono text-xs md:text-sm text-[var(--text-secondary)] mb-12 space-y-2 border-l-2 border-[var(--accent-error)]/20 pl-4 py-2">
            <p className="flex gap-4">
              ...
              <span>CRITICAL_ERROR: 404_PAGE_NOT_FOUND</span>
            </p>
            <p className="flex gap-4">
              <span className="opacity-50">00:00:02</span>{" "}
              <span>MODULE_MISSING: /requested_url</span>
            </p>
            <p className="flex gap-4">
              <span className="opacity-50">00:00:03</span>{" "}
              <span>ATTEMPTING_RECOVERY... [FAILED]</span>
            </p>
            <p className="flex gap-4 text-[var(--accent-error)]">
              <span className="opacity-50">00:00:04</span>{" "}
              <span>SYSTEM_HALTED. PLEASE_REBOOT.</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/"
              className="flex-1 flex items-center justify-center gap-2 bg-[var(--accent-error)] text-black px-6 py-4 font-bold hover:bg-white transition-colors uppercase text-sm group tracking-wider"
            >
              <Home size={16} />
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border border-[var(--text-secondary)] text-[var(--text-secondary)] px-6 py-4 hover:border-[var(--accent-error)] hover:text-[var(--accent-error)] transition-colors uppercase text-sm tracking-wider"
            >
              <RefreshCcw size={16} />
