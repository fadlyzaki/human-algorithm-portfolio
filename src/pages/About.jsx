          ...
          <section className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-12 mb-24 fade-in items-start">
            ...
            <div>
              <div style={chaosStyle}>
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-sm bg-[var(--accent-green)]/10 text-[var(--accent-green)] border border-[var(--accent-green)]/20 font-mono text-[10px] uppercase tracking-wider">
              ...
              <div className="mt-12 max-w-sm relative">
                ...
                <div className={`mt-4 transition-opacity duration-300 ${chaosStrength > 50 ? 'opacity-100' : 'opacity-0'}`}>
                  <p className="font-mono text-[10px] text-[var(--accent-green)] uppercase tracking-wider flex items-center gap-2">
                    <Shield size={12} />
          ...
          <section className="mb-24">
            <ScrollReveal>
              <div className="flex items-baseline gap-4 mb-8">
                <span className="font-mono text-sm text-[var(--accent-blue)] opacity-60 uppercase tracking-wider">
