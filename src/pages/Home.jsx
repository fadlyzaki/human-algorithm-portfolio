    ...
    >
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-24 border-x border-[var(--border-color)] min-h-screen bg-[var(--bg-backdrop)] backdrop-blur-sm transition-colors duration-500">
        ...
        <div className="fade-in pt-12">
            ...
            <section className="relative mb-40">
              <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-12 items-start">
                ...
                <div className="hidden md:block">
                   <div className="w-full aspect-square bg-[var(--bg-card)] border border-[var(--border-color)] mb-6 relative group overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                      <div className="absolute inset-0 flex items-center justify-center text-[var(--text-secondary)]">
                        <User size={64} strokeWidth={1} />
                      </div>
                      <div className={`absolute inset-0 bg-gradient-to-tr ${isDark ? 'from-[#111]' : 'from-[#FFF]'} to-transparent opacity-60`}></div>
            ...
            {/* --- RUNTIME MODULES (Updated Gallery) --- */}
            <section className="mb-40">
               <SectionTitle number="1.5" title="RUNTIME MODULES" />
               
               <p className="text-[var(--text-secondary)] text-lg mb-12 max-w-2xl">
                 The system never really sleeps. Even during the break, background processes were running—active experiments to keep the creative logic sharp.
               </p>

               {/* Bento Grid Layout */}
               <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 auto-rows-[120px]">
                  
                  {/* --- SUBSECTION: MAINTENANCE (HOBBIES) --- */}
                  ...
                  {/* --- SUBSECTION: ACTIVE DAEMONS (SIDE PROJECTS) --- */}
                  
                  {/* Divider / Label */}
                  <div className="col-span-full mt-8 mb-2 flex items-center gap-4">
                     <div className="h-px bg-[var(--border-color)] flex-1"></div>
                     <span className="font-mono text-xs text-[var(--accent-amber)] uppercase tracking-widest">Active Daemons (Side Projects)</span>
                     <div className="h-px bg-[var(--border-color)] flex-1"></div>
                  </div>
            ...
            <section id="philosophy" className="mb-40 relative scroll-mt-24">
              <SectionTitle number="3" title="PHILOSOPHY" />
