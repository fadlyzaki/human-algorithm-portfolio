export const stoqo = {
  ...
  miniDesc_id:
    "Logistik bukan cuma soal mindahin kardus. Ini soal kecemasan pemilik restoran yang nunggu jam 4 pagi, bertanya-tanya apakah bahan masakannya bakal nyampe.",
  stats: [
  ...
  culture: {
    ...
    images: [
      {
        src: "/work/stoqo-team.jpg",
        caption: "My Birthday years ago!",
        span: "md:col-start-1 md:row-start-1",
      },
      {
        src: "/work/stoqo-hawaiian.jpg",
        caption: "Halloween day at the office",
        span: "md:col-start-1 md:row-start-2",
      },
      {
        src: "/work/stoqo-office.jpg",
        caption: "At the HQ",
        span: "md:col-start-2 md:row-start-1 md:row-span-2 h-full",
      },
      {
        src: "/work/stoqo-batik.jpg",
        caption: "Early days of Stoqo",
        span: "md:col-start-3 md:row-start-1",
      },
      {
        src: "/work/stoqo-remote.jpg",
        caption: "Design Team Assemble",
  ...
  projects: [
    {
      ...
      caseStudy: {
        ...
        process: [
          ...
          {
            title: "Field Study",
            desc: "I joined the Field Activators to see the chaos on the ground. This bridged the gap between 'Customer Complaints' and 'Operational Reality'.",
            image: "airy:ecosystem",
          },
          {
            title: "Analysis Workshop",
            desc: "I facilitated the journey mapping session where we identified 4 pain points: Mental Model Mismatch, Uncertainty, Lack of Communication, and Lack of Awareness.",
            image: "airy:matrix",
          },
          {
            title: "Co-Creation",
        ...
        insights: [
          ...
          {
            title: "The 'Early' Problem",
            desc: "Surprisingly, drivers arriving too early was also a disruption. Customers weren't ready to receive goods at 3 AM if they expected 5 AM.",
          },
        ],
        solution: [
          {
        ...
        learnings:
          "Transparency is cheaper than speed. Users will wait if they know why. This project wasn't about UI; it was about selling 'peace of mind' as a feature.",
        designProcess: [
          {
            type: "research",
            title: "Methodology",
            ...
            title_id: "Metodologi",
            desc_id:
              "Saya tidak percaya tiket Jira, jadi saya ikut naik truk pengiriman. Saya melihat sopir kesulitan SMS sambil menyetir. Sistemnya bukan rusak; tapi berbahaya.",
            image: "airy:timeline",
          },
          {
            type: "insight",
            ...
            desc_id:
              "Setelah bicara dengan 5 pemilik warung, saya temukan konflik aslinya: Masalahnya bukan kecepatan. Tapi kesunyian (ketidaktahuan). Mereka bisa terima telat; tapi nggak bisa terima kalau nggak dikabarin.",
            image: "airy:venn",
          },
          {
            type: "design",
          ...
          },
          {
            ...
            title_id: "Ko-Kreasi",
            desc_id:
              "Saya tidak mendesain sendirian. Saya pimpin workshop seharian bareng Lead Engineering dan Ops untuk memastikan desain ini bisa dibangun (feasible).",
            image: "airy:flow",
          },
          {
            type: "measure",
            ...
            title_id: "Validasi",
            desc_id:
              "Saya bawa high-fidelity prototype kembali ke user untuk testing sprint 3 hari. Melihat mereka bingung adalah validasi terbaik.",
            image: "airy:chart",
          },
        ],
      ...
      caseStudy_id: {
        ...
        challenge:
          "Saya menemukan fakta pahit: pengguna kami bangun jam 4 pagi bukan untuk bekerja, tapi untuk menunggu. Pengiriman terlambat bukan cuma ketidaknyamanan; ini ancaman eksistensial bagi usaha warung mereka. Tantangan saya adalah memutus siklus kecemasan ini tanpa punya budget untuk beli 100 truk baru.",
        process: [
          {
            title: "Metodologi",
            desc: "Saya tidak percaya tiket Jira, jadi saya ikut naik truk pengiriman. Saya melihat sopir kesulitan SMS sambil menyetir. Sistemnya bukan rusak; tapi berbahaya.",
            image: "airy:timeline",
          },
          {
            title: "Insight Utama",
            desc: "Setelah bicara dengan 5 pemilik warung, saya temukan konflik aslinya: Masalahnya bukan kecepatan. Tapi kesunyian (ketidaktahuan). Mereka bisa terima telat; tapi nggak bisa terima kalau nggak dikabarin.",
            image: "airy:venn",
          },
          {
            title: "Studi Lapangan",
            desc: "Saya bergabung dengan Field Activators untuk melihat kekacauan di lapangan. Ini menjembatani 'Keluhan Pelanggan' dengan 'Realita Operasional'.",
            image: "airy:ecosystem",
          },
          {
            title: "Workshop Analisis",
            desc: "Saya memfasilitasi sesi journey mapping di mana kami identifikasi 4 pain points: Mismacth Mental Model, Ketidakpastian, Kurang Komunikasi, dan Kurang Awareness.",
            image: "airy:matrix",
          },
          {
            title: "Ko-Kreasi",
            desc: "Saya tidak mendesain sendirian. Saya pimpin workshop seharian bareng Lead Engineering dan Ops untuk memastikan desain ini bisa dibangun (feasible).",
            image: "airy:flow",
          },
          {
            title: "Ideasi",
        ...
        insights: [
          {
            title: "Psikologi Menunggu",
            desc: "Menunggu yang jelas estimasinya terasa lebih cepat daripada menunggu tanpa kabar. Estimasi kasar pun bisa menenangkan user.",
          },
          {
            title: "Masalah 'Kepagian'",
            desc: "Ternyata, sopir yang datang kepagian juga masalah. Warung belum siap terima barang jam 3 pagi kalau janjinya jam 5.",
          },
        ],
        solution: [
          {
            title: "Pelacakan Status",
            desc: "Saya curi mental model dari Domino's Pizza. Kalau pizza 50 ribu aja bisa dilacak, kenapa beras 500 ribu enggak?",
            image: "airy:radar",
          },
          {
            title: "Notifikasi Proaktif",
            desc: "Berhenti nunggu user nanya. Saya desain notifikasi yang otomatis dikirim begitu truk keluar dari gudang.",
            image: "airy:flow",
          },
          {
            title: "Info Pengemudi",
            desc: "Info kontak sopir yang aman, memberi user jalur langsung ke barang mereka.",
            image: "airy:ui",
          },
        ],
        metrics: [
        ...
        learnings:
          "Transparansi itu lebih murah daripada kecepatan. User mau nunggu kalau mereka tau alasannya. Proyek ini bukan soal UI; ini soal menjual 'ketenangan pikiran' sebagai fitur.",
        aiHypotheses: [
          {
            tech: "Computer Vision & IoT",
    ...
    },
    {
      ...
      caseStudy: {
        ...
        challenge:
          "Our 'Field Activators' (Sales Team) were churning faster than we could hire them. The root cause wasn't salary; it was 'KPI Anxiety'. They didn't understand how they were being measured, leading to a breakdown of trust.",
        process: [
          {
        ...
        designProcess: [
          {
            ...
            desc_id:
              "Kami temukan celah kritis: 'TL tidak paham definisi KPI'. Kalau pemimpinnya bingung, pasukannya tersesat.",
            image: "airy:flow",
          },
          {
            type: "insight",
            ...
            desc_id:
              "Riset kami mengungkap: 'Tidak Ada Kepercayaan = Tidak Ada Aksi'. Saat keandalan data dipertanyakan, motivasi runtuh.",
            image: "airy:venn",
          },
          {
            type: "design",
          ...
          },
          {
            ...
            desc_id:
              "Kami perkenalkan 'Sistem Tier' dan lencana untuk menyentuh motivasi internal, lebih dari sekadar uang.",
            image: "airy:architecture",
          },
          {
            type: "ship",
            ...
            desc_id:
              "Kami buat 'Video Animasi' dan infografis standar agar setiap FA paham aturan mainnya.",
            image: "airy:ecosystem",
          },
        ],
        insights: [
          {
            title: "The 'Admin Day' Fix",
            desc: "We institutionalized 'Admin Day' for Team Leaders to sync data offline, reducing the 'confusion and anxiety' caused by connectivity gaps.",
          },
          {
            title: "Melody Bypass",
            desc: "We found that rhythm helps retention. We used catchy, repetitive formats for KPI updates to bypass cognitive overload.",
          },
        ],
        solution: [
          {
        ...
        learnings:
          "You don't always need complex gamification with avatars and leaderboards. Sometimes, the best game mechanic is just Knowing the Score.",
        ...
        aiHypotheses: [
          ...
          },
          {
            ...
            desc: "AI analyzes individual agent performance and dynamically generates personalized daily challenges to push them out of their comfort zones.",
            impact: "Higher Target Achievement",
          },
          {
            tech: "Social AI & Network Analysis",
            title: "Peer Mentor Matching",
            desc: "AI identifies top performers and struggling agents, creating mentor-mentee pairs with suggested talking points and successful pattern transfers.",
            impact: "Better Team Performance",
          },
          {
            tech: "Emotion AI",
            title: "Burnout Detector",
            desc: "AI analyzes voice tone and activity pauses. If an agent sounds exhausted, it suggests a 15-minute break or slightly reduces daily targets to prevent churn.",
            impact: "Improved Agent Retention",
          },
          {
            tech: "Knowledge Graph RAG",
            title: "Instant Competitor Battlecard",
            desc: "Agents spot a competitor's flyer at a store and take a photo. AI reads it and whispers: 'Our oil is cheaper, mention that now!'.",
      ...
      caseStudy_id: {
        aiHypotheses: [
          {
            tech: "Agen Pelatih Personal",
            title: "'Jarvis' untuk Sales",
            desc: "Pelatih suara AI yang mendengarkan panggilan sales (aman-privasi) dan membisikkan secara real-time: 'Bicara lebih pelan', 'Sebutkan diskon bundle sekarang', 'Mereka kedengaran ragu soal harga'.",
            impact: "Tingkat Konversi Tinggi",
          },
          {
            tech: "ML & Analisis Performa",
            ...
            impact: "Pencapaian Target Tinggi",
          },
          {
            tech: "AI Sosial & Analisis Jaringan",
            title: "Pencocokan Mentor Rekan",
            desc: "AI mengidentifikasi top performer dan agen yang kesulitan, lalu membuat pasangan mentor-mentee dengan poin diskusi dan transfer pola sukses yang disarankan.",
    ...
    },
    {
      ...
      iconName: "Scan",
      details: {
        problem: "The panic of a lost invoice in a chaotic kitchen.",
        system: "Camera-as-Keyboard.",
        outcome: 'No more "lost money".',
      },
      details_id: {
        problem: "Paniknya bon hilang di dapur yang chaos.",
        system: "Kamera-jadi-Keyboard.",
        outcome: 'Gak ada lagi "uang hilang".',
      },
      ...
      caseStudy: {
        ...
        challenge:
          "Our office was drowning in paper. Invoices, delivery orders, receipts. Things got lost, coffee got spilled, and data was dark.",
        process: [
          {
            title: "Observation",
        ...
        designProcess: [
          {
            ...
            title_id: "Observasi",
            desc_id:
              "Saya perhatikan tim admin menghabiskan 4 jam sehari cuma buat ketik ulang data dari kertas ke komputer.",
            image: "airy:cycle",
          },
          {
            type: "design",
            ...
            title_id: "Ideasi",
            desc_id:
              "Gimana kalau kamera jadi keyboard-nya? Saya mock-up alur OCR yang otomatis ngisi formulir.",
            image: "airy:flow",
          },
          {
            type: "insight",
            ...
            desc_id:
              "User awalnya skeptis sama akurasi OCR. Saya desain UI 'Skor Kepercayaan' untuk highlight field yang meragukan.",
            image: "airy:venn",
          },
        ],
        challenge_id:
        ...
        insights_id: [
          {
            title: "Percaya Mesin",
            desc: "User awalnya skeptis sama akurasi OCR. Saya desain UI 'Skor Kepercayaan' (Confidence Score) yang menghighlight kolom mana yang AI-nya ragu, jadi user bisa cek ulang.",
          },
        ],
        solution: [
          {
        ...
        learnings:
          "The future is inevitable, but it needs a bridge. The 'Confidence Score' was the bridge that let users trust the AI.",
        aiHypotheses: [
          {
