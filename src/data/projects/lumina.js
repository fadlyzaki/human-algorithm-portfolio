...
export const lumina = {
    ...
    culture: {
        ...
        images: [
            ...
            { src: "/work/lumina_arena_5.jpg", caption: "Late Night Innovation", span: "md:col-start-1 md:row-start-2", pos: "object-bottom" },
            { src: "/work/lumina_arena_2.jpg", caption: "Me at JobFair", span: "md:col-start-2 md:row-start-1 md:row-span-2 h-full", pos: "object-center" },
            { src: "/work/lumina_arena_3.jpg", caption: "Community Engagement", span: "md:col-start-3 md:row-start-1", pos: "object-center" },
            { src: "/work/lumina_arena_6.jpg", caption: "Badminton Team Building", span: "md:col-start-3 md:row-start-2", pos: "object-center" }
        ]
    },
    culture_id: {
        title: "Medan Juang",
