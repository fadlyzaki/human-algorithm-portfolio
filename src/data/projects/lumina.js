export const lumina = {
  ...
  hook_id:
    "Memberi martabat pada pencarian kerja. Platform komunitas yang memastikan pekerja kerah biru tidak merasa seperti sedang mengemis pekerjaan.",
  miniDesc_id:
    'Membangun "LinkedIn" untuk pekerja tangan. Merancang sistem reputasi dan membangun praktik Design Ops untuk mengelola alur kerja freelance.',
  companyFocus_id: {
    title: "Konteks Unik",
  ...
  culture: {
    ...
    images: [
      {
        src: "/work/lumina_arena_4.jpg",
        caption: "Field Research & Career Clinic",
        span: "md:col-start-1 md:row-start-1",
        pos: "object-center",
      },
      {
        src: "/work/lumina_arena_5.jpg",
        caption: "Late Night Innovation",
        span: "md:col-start-1 md:row-start-2",
        pos: "object-bottom",
      },
      {
        src: "/work/lumina_arena_2.jpg",
        caption: "Me at JobFair",
        span: "md:col-start-2 md:row-start-1 md:row-span-2 h-full",
        pos: "object-center",
      },
      {
        src: "/work/lumina_arena_3.jpg",
        caption: "Community Engagement",
        span: "md:col-start-3 md:row-start-1",
        pos: "object-center",
      },
      {
        src: "/work/lumina_arena_6.jpg",
        caption: "Badminton Team Building",
  ...
  projects: [
    {
      ...
      caseStudy: {
        ...
        challenge:
          "Recruiters were drowning. Managing 200+ candidates via Excel and personal WhatsApp accounts meant data was scattered and response times averaged 4 days. Candidates were ghosting us because we were too slow.",
        process: [
          {
            title: "The Shadow",
          ...
          {
            title: "The Conflict",
            desc: "Engineering wanted to build a ticketing system. I argued for a Chat interface. Tickets feel like work; Chat feels like a conversation.",
            image: "airy:venn",
          },
          {
            title: "Prototyping",
        ...
        insights: [
          ...
          {
            title: "Batching vs. Real-time",
            desc: "Recruiters work in batches; candidates work in real-time. I had to design a system that bridged this async/sync gap.",
          },
        ],
        solution: [
          {
          ...
          {
            title: "One-Tap Speed",
            desc: "I designed 'Smart Templates' that allowed recruiters to send commonly used replies (e.g., 'Interview Scheduled') in a single tap.",
            image: "airy:flow",
          },
        ],
        metrics: [
        ...
        learnings:
          "This project taught me that 'features' don't solve problems; 'workflows' do. By mimicking the tool they already used (WhatsApp) but adding structure, I won adoption without training.",
        designProcess: [
          {
            type: "research",
            title: "The Shadow",
            ...
            desc_id:
              "Saya duduk bareng 5 rekruter selama satu shift. Saya liat mereka copy-paste pesan yang sama 50 kali. Ini bukan masalah 'tracking', ini masalah 'ngetik'.",
            image: "airy:timeline",
          },
          {
            type: "insight",
            ...
            desc_id:
              "Kandidat nyuekin email karena terlalu formal. Chat terasa aman. Mediumnya adalah pesannya.",
            image: "airy:venn",
          },
          {
            type: "design",
            ...
            title_id: "Prototipe",
            desc_id:
              "Saya bikin prototipe mirip WhatsApp dan verifikasi langsung sama pekerja kerah biru. Kalau mereka bisa pake WhatsApp, mereka pasti bisa pake ini.",
            image: "airy:ui",
          },
          {
            type: "ship",
            ...
            desc_id:
              "Saya gabungin SMS, WhatsApp, dan In-App jadi satu thread. Gak perlu gonta-ganti tab lagi.",
            image: "airy:layers",
          },
          {
            type: "measure",
            ...
            desc_id:
              "Rekruter melihat peningkatan signifikan dalam tingkat respon karena antarmuka chat yang familiar.",
            image: "airy:chart",
          },
        ],
        aiHypotheses: [
    ...
    },
    {
      ...
      caseStudy: {
        ...
        snapshot: {
          tagline:
            "Replacing the 'Excel Comfort Blanket' with something better.",
        ...
        challenge:
          "HR data was fragmented across 5 different tools and giant spreadsheets. The team couldn't answer simple questions like 'How many drivers did we hire today?' without a standardizing ease.",
        process: [
          {
            title: "The Audit",
          ...
          {
            title: "Friction",
            desc: "Users resisted the new dashboard. They loved Excel's flexibility. I had to prove that 'structure' was worth the loss of 'freedom'.",
            image: "airy:kanban",
          },
        ],
        insights: [
        ...
        learnings:
          "Replacing a spreadsheet is the hardest design challenge. You can't just be prettier; you have to be faster. I learned to respect the utility of a grid.",
        designProcess: [
          {
            type: "research",
            title: "The Audit",
            ...
            desc_id:
              "Saya print semua spreadsheet dan stabilo-in setiap kolom yang duplikat. Ternyata kami minta data yang sama sampe 4 kali.",
            image: "airy:matrix",
          },
          {
            type: "insight",
            ...
            desc_id:
              "Kebanyakan dashboard modern kebanyakan ruang kosong (whitespace). User HR butuh kepadatan data. Saya desain supaya informasi maksimal per piksel.",
            image: "airy:kanban",
          },
          {
            type: "design",
            ...
            desc_id:
              "Saya bikin papan Kanban drag-and-drop yang memvisualisasikan perjalanan kandidat. Langsung keliatan macetnya di mana.",
            image: "airy:funnel",
          },
          {
            type: "ship",
            ...
            desc_id:
              "User gak pernah kerja satu-satu. Saya tambahin fitur 'Pilih Semua' (Select All) di setiap tahap.",
            image: "airy:data",
          },
          {
            type: "measure",
            ...
            title_id: "Efisiensi",
            desc_id:
              "Kecepatan rekruter meningkat signifikan, dengan akurasi data hampir sempurna dan adopsi tim penuh.",
            image: "airy:chart",
          },
        ],
        aiHypotheses: [
      ...
      caseStudy_id: {
        ...
        snapshot: {
          tagline:
            "Ganti 'Selimut Nyaman' Excel dengan sesuatu yang lebih baik, tanpa bikin kaget.",
          heroImage: "airy:kanban",
        },
        context: {
        ...
        challenge:
          "Data HR berantakan di 5 tools beda dan spreadsheet raksasa. Tim gak bisa jawab pertanyaan simpel kayak 'Berapa driver yang kita rekrut hari ini?' tanpa pusing dulu.",
        process: [
          {
            title: "Audit Total",
            desc: "Saya print semua spreadsheet dan stabilo-in setiap kolom yang duplikat. Ternyata kami minta data yang sama sampe 4 kali.",
            image: "airy:matrix",
          },
          {
            title: "Friksi",
            desc: "User nolak dashboard baru. Mereka cinta banget fleksibilitas Excel. Saya harus buktiin kalau 'struktur' itu sepadan dengan hilangnya 'kebebasan'.",
            image: "airy:kanban",
          },
        ],
        insights: [
          {
            title: "Kepadatan itu Raja",
            desc: "Kebanyakan dashboard modern kebanyakan ruang kosong (whitespace). User HR butuh kepadatan data. Saya desain supaya informasi maksimal per piksel.",
          },
        ],
        solution: [
          {
            title: "Pipeline Visual",
            desc: "Saya bikin papan Kanban drag-and-drop yang memvisualisasikan perjalanan kandidat. Langsung keliatan macetnya di mana.",
            image: "airy:funnel",
          },
          {
            title: "Aksi Massal",
            desc: "User gak pernah kerja satu-satu. Saya tambahin fitur 'Pilih Semua' (Select All) di setiap tahap.",
            image: "airy:data",
          },
        ],
        metrics: [
        ...
        learnings:
          "Gantiin Excel itu tantangan desain paling susah. Gak bisa cuma main cantik; harus lebih cepet. Saya belajar buat menghargai fungsi grid.",
        aiHypotheses: [
          {
            tech: "RAG (Retrieval-Augmented Generation)",
    ...
    },
    {
      ...
      caseStudy: {
        ...
        challenge:
          "We had a 90% drop-off rate on our application forms. Blue-collar workers weren't comfortable typing out long resumes on mobile screens. The 'Resume Wall' was killing our growth.",
        process: [
          {
            title: "Trust Audit",
          ...
          },
          {
            ...
            desc: "We looked at Tokopedia and Shopee. They all had 'Escrow' badges. B2B users expected consumer-grade safety.",
            image: "airy:venn",
          },
        ],
        insights: [
        ...
        designProcess: [
          {
            ...
            title_id: "Taruhan",
            desc_id:
              "Hipotesis saya: User bukan gak berkualitas, tapi kurang PD. Formulir rasanya kayak ujian. Chat rasanya kayak nyapa.",
            image: "airy:funnel",
          },
          {
            type: "insight",
            ...
            desc_id:
              "User gak percaya sama formulir tanpa wajah. Mereka percaya sama orang. Saya tambahin 'Avatar Rekruter' buat memanusiakan layar.",
            image: "airy:venn",
          },
          {
            type: "design",
            ...
            desc_id:
              "Saya ganti formulir 'Apply Now' dengan pesan template: 'Halo, saya tertarik sama kerjaan ini.'.",
            image: "airy:flow",
          },
          {
            type: "ship",
            ...
            desc_id:
              "Buat user yang susah ngetik, saya tambahin fitur 'Rekam Suara'. Jadi fitur paling laku.",
            image: "airy:ui",
          },
          {
            type: "measure",
            ...
            desc_id:
              "Volume lamaran melonjak dan tingkat penyelesaian lebih tinggi karena pengurangan friksi.",
            image: "airy:chart",
          },
        ],
        aiHypotheses: [
      ...
      caseStudy_id: {
        ...
        challenge:
          "90% pelamar kabur pas liat formulir lamaran. Pekerja kerah biru gak nyaman ngetik CV panjang di layar HP. 'Tembok CV' ini membunuh pertumbuhan user kami.",
        process: [
          {
            title: "Taruhan",
            desc: "Hipotesis saya: User bukan gak berkualitas, tapi kurang PD. Formulir rasanya kayak ujian. Chat rasanya kayak nyapa.",
            image: "airy:funnel",
          },
          {
            title: "Pangkas Habis",
            desc: "Saya debatin buat hapus 80% kolom isian. Kita cuma butuh Nama dan Nomor HP buat mulai.",
            image: "airy:venn",
          },
        ],
        insights: [
          {
            title: "Defisit Kepercayaan",
            desc: "User gak percaya sama formulir tanpa wajah. Mereka percaya sama orang. Saya tambahin 'Avatar Rekruter' buat memanusiakan layar.",
          },
        ],
        solution: [
          {
            title: "Lamar Satu Tap",
            desc: "Saya ganti formulir 'Apply Now' dengan pesan template: 'Halo, saya tertarik sama kerjaan ini.'.",
            image: "airy:flow",
          },
          {
            title: "Voice Notes",
            desc: "Buat user yang susah ngetik, saya tambahin fitur 'Rekam Suara'. Jadi fitur paling laku.",
            image: "airy:ui",
          },
        ],
        metrics: [
    ...
    },
    {
      ...
      caseStudy: {
        ...
        challenge:
          "Our analytics showed users were getting stuck in deep navigation trees and abandoning the app. We had over-engineered the category structure, assuming users knew exactly what they wanted. They didn't.",
        process: [
          {
            title: "Card Sorting",
          ...
          {
            title: "Hard Choices",
            desc: "I had to convince the PMs to kill their favorite 'Advanced Search' features. Simplicity requires sacrifice.",
            image: "airy:funnel",
          },
        ],
        insights: [
        ...
        learnings:
          "Navigation is not just about structure; it's about confidence. If a user feels lost for 1 second, they are gone. I learned to count clicks like currency.",
        designProcess: [
          {
            type: "research",
            title: "Card Sorting",
            ...
            desc_id:
              "Saya lakukan card-sorting dengan user asli. Mental model mereka itu datar (flat), bukan hirarkis macam pohon.",
            image: "airy:hierarchy",
          },
          {
            type: "insight",
            ...
            desc_id:
              "User kami adalah pembelajar visual. Mereka mengabaikan label teks tapi langsung klik ikon. Saya ubah desain jadi icon-first.",
            image: "airy:venn",
          },
          {
            type: "design",
            ...
            desc_id:
              "Saya pangkas kedalaman navigasi dari 4 level jadi 2. Setiap lowongan kerja kini bisa dijangkau dalam 2 tap.",
            image: "airy:layers",
          },
          {
            type: "ship",
            ...
            title_id: "Tag Visual",
            desc_id:
              "Saya desain set ikon unik untuk setiap kategori pekerjaan, berfungsi sebagai jangkar visual saat scanning cepat.",
            image: "airy:ecosystem",
          },
          {
            type: "measure",
            ...
            title_id: "Retensi D1",
            desc_id:
              "Meningkatkan retensi Hari-1 dan tingkat keberhasilan pencarian yang tinggi dengan penurunan bounce rate.",
            image: "airy:chart",
          },
        ],
        aiHypotheses: [
