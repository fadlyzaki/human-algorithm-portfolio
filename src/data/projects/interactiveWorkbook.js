export const interactiveWorkbook = {
  ...
  subtitle: {
    en: "Bilingual Learning Platform",
  ...
  links: {
    ...
    repo: "github.com/fadlyzaki/interactive-workbook",
  },
  ...
  process: [
    {
      title: {
        en: "1. Core Experience: Dual Dashboards",
        id: "1. Pengalaman Inti: Dasbor Ganda",
      },
      desc: {
    ...
    {
      title: {
        en: "2. The 6-Step Pedagogical Flow",
        id: "2. Alur Pedagogis 6 Langkah",
      },
      desc: {
    ...
    {
      title: {
        en: "3. Real-Time Tracking Architecture",
        id: "3. Arsitektur Pelacakan Real-Time",
      },
      desc: {
  ...
  insights: [
    {
      title: {
        en: "AI Conversation Tutor (Planned)",
        id: "Tutor Percakapan AI (Direncanakan)",
      },
      desc: {
    ...
    {
      title: {
        en: "Adaptive Learning Engine (Planned)",
        id: "Mesin Pembelajaran Adaptif (Direncanakan)",
      },
      desc: {
    ...
    {
      title: {
        en: "Automated Assessment (Planned)",
        id: "Penilaian Otomatis (Direncanakan)",
      },
      desc: {
  ...
  solution: [
    {
      title: {
        en: "Seamless Language Switching",
        id: "Pergantian Bahasa Mulus",
      },
      desc: {
    ...
    {
      title: {
        en: "Duolingo for Schools Integration",
        id: "Integrasi Duolingo for Schools",
      },
      desc: {
  ...
  designProcess: [
    ...
    },
    {
      type: "measure",
      title: {
        en: "Automated Assessment Future",
        id: "Masa Depan Penilaian Otomatis",
      },
      desc: {
