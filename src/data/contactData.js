...
export const socialMatrix = [
  {
    ...
    items: [
      ...
      },
      {
        name: "Dribbble",
        icon: Dribbble,
        url: "https://dribbble.com/fadlyzaki",
        color: "hover:text-pink-500",
      },
      {
        name: "GitHub",
        icon: FileText,
        url: "https://github.com/fadlyzaki/",
    ...
    items: [
      {
        name: "Twitter / X",
        icon: Twitter,
        url: "https://x.com/Fadlyzaki",
        color: "hover:text-sky-500",
      },
      {
        name: "Instagram",
        icon: Instagram,
        url: "https://www.instagram.com/fadlyzaki",
    ...
    items: [
      {
        name: "Medium",
        icon: BookOpen,
        url: "https://medium.com/@fadlyzaki",
