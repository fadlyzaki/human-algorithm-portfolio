export const EXPERIMENTS = [
  {
    ...
    sections_id: {
      challenge:
        "Medsos sekarang cuma mau nyuri perhatian kita. Akibatnya user gak punya kendali, cuma dikasih konten sampah biar terus scroll.",
      approach:
        "Kita sadar user itu mood-nya berubah-ubah. Jadi kita pindahin kontrolnya langsung ke Feed, pake cara yang halus (Stealth UX).",
    },
    ...
    designProcess: [
      {
        ...
        desc_id:
          "Medsos beralih dari Koneksi ke Retensi Atensi. Idealnya, user harus jadi pilot, bukan penumpang.",
        image: "airy:hierarchy",
      },
      {
        type: "insight",
        ...
        desc_id:
          "User gak punya preferensi statis; punya mood. Kadang 'Doom Scroll', kadang 'Hanya Teman'. Menu setting terlalu kaku.",
        image: "airy:venn",
      },
      {
        type: "design",
        ...
        desc_id:
          "Ubah header 'For You' jadi dropdown. User bisa switch ke 'Hanya Teman' instan. Bising hilang.",
        image: "airy:ui",
      },
      {
        type: "ship",
        ...
        desc_id:
          "Implementasi filter audio cepat dan potongan kasar. Feed jadi majalah digital, bukan mesin slot.",
        image: "airy:layers",
      },
      {
        type: "measure",
        ...
        desc_id:
          "Memberi kontrol balik meningkatkan kepercayaan. Interaksi teman naik 3x lipat saat noise hilang.",
        image: "airy:radar",
      },
    ],
    challenge_id:
      "Medsos beralih dari Koneksi ke Retensi Atensi. Ini mencuri agensi user, menciptakan 'Feed Sampah' demi dopamin murah. User merasa dimanipulasi.",
    process_id: [
      {
  ...
  },
  {
    ...
    tldr_id:
      "Kami membuat tombol 'pause' untuk inflasi bagi traveler yang cemas.",
  ...
  },
  {
    ...
    tldr_id:
      "Kami membangun 'Grab Bakti': infrastruktur emosional yang mengkonversi remitansi menjadi aksi kasih sayang nyata.",
    desc_id:
      "Platform bagi perantau untuk mengirim perhatian, bukan sekadar uang.",
    ...
    designProcess: [
      ...
      },
      {
        ...
        desc_id:
          "Perantau Indonesia kirim triliunan tiap tahun. Kami konversi remitansi jadi GTV. Pesanan hadiah punya AOV 2.5x lebih tinggi. Saat Ibu terima makanan via link WhatsApp tanpa install aplikasi, kita bangun kepercayaan.",
        image: "airy:chart",
      },
      {
        type: "design",
    ...
    challenge_id:
      "Saya perantau. Jauh dari Padang. Saat Ibu kurang enak badan, saya ingin kirim Martabak Hayuda atau Sate Mak Syukur. Tapi GPS mengunci saya di Jakarta. Grab ada di Jakarta, Grab ada di Padang. Kenapa tidak bisa dijembatani? Teknologi hari ini memaksa kita 'ada di sana' untuk bisa memesan.",
    process_id: [
      {
  ...
  },
  {
    ...
    tldr_id:
      "Peringatan geospasial tanpa blindspot selama kejadian banjir kritis.",
    snapshot: {
    ...
    designProcess: [
      {
        ...
        desc_id:
          "Jakarta tenggelam 10cm/tahun. Sensor pemerintah cover sungai, tapi got mikro di pemukiman gak terpantau.",
        image: "airy:ecosystem",
      },
      {
        type: "insight",
        ...
        desc_id:
          "Orang lebih percaya tetangga daripada pemerintah saat bencana. Sistem verifikasi P2P itu krusial.",
        image: "airy:network",
      },
      {
        type: "design",
        ...
        desc_id:
          "Kami desain sistem peringatan crowdsource. Agregasi data sensor dan laporan warga buat rute evakuasi aman.",
        image: "airy:architecture",
      },
      {
        type: "ship",
        ...
        desc_id:
          "Dibangun pakai PostGIS & Node.js untuk akurasi spasial. Peringatan di-push real-time ke warga terdampak.",
        image: "airy:radar",
      },
      {
        type: "measure",
        ...
        desc_id:
          "Cakupan tanpa blindspot selama banjir kritis. Kepercayaan tinggi dari komunitas.",
        image: "airy:chart",
      },
    ],
    challenge_id:
      "Jakarta tenggelam 10cm/tahun. Peringatan tradisional terlalu umum, membuat warga terjebak di area 'blindspot' saat banjir bandang.",
    process_id: [
      {
  ...
  },
  {
    ...
    tldr_id:
      "Desain ulang frontend yang memfilter konten berdasarkan Waktu Tersedia dan Beban Kognitif.",
    ...
    designProcess: [
      {
        ...
        desc_id:
          "Pengguna buka aplikasi dengan batasan ('Cuma punya 20 menit') atau kondisi ('Lagi capek'). Antarmuka memaksa mereka menelusuri silo generik.",
        image: "airy:chart",
      },
      {
        type: "insight",
        ...
        desc_id:
          "Persona 'Budi' punya tepat 25 menit untuk makan. Dia butuh tontonan yang selesai pas makanannya habis.",
        image: "airy:timeline",
      },
      {
        type: "design",
        ...
        desc_id:
          "Rel navigasi lengket yang memfilter konten berdasarkan 'Waktu Tersedia' dan 'Beban Kognitif'.",
        image: "airy:funnel",
      },
      {
        type: "ship",
        ...
        desc_id:
          "Menonaktifkan trailer auto-play dan memudarkan warna saat mode 'Santai' aktif untuk menyesuaikan energi rendah pengguna.",
        image: "airy:ui",
      },
      {
        type: "measure",
        ...
        desc_id:
          "Menargetkan pengurangan 40% dalam Time-to-Play (Waktu-ke-Putar) dengan menyelaraskan konten dengan konteks pengguna.",
        image: "airy:chart",
      },
    ],
    challenge_id:
      "Antarmuka streaming saat ini memprioritaskan inventaris konten (Genre) daripada konteks pengguna (Waktu & Energi). Ketidakcocokan ini menyebabkan 'Kelelahan Keputusan', membuat pengguna pergi ke TikTok.",
    process_id: [
      {
  ...
  },
  {
    ...
    tldr_id:
      "Menggunakan AR untuk membunuh 'Celah Kepercayaan' dalam belanja kosmetik online.",
    ...
    designProcess: [
      {
        ...
        desc_id:
          "Survei user mengungkap masalah paling perih: mereka gak bisa pegang atau coba produknya. Butuh teknologi buat jembatanin celah fisik ini.",
        image: "airy:radar",
      },
      {
        type: "insight",
        ...
        desc_id:
          "Filter media sosial (Snapchat/IG) udah akrab buat milenial. Hipotesis kami: gimana kalau interaksi akrab ini dipake buat belanja?",
        image: "airy:venn",
      },
      {
        type: "design",
        ...
        desc_id:
          "Kami pake framework Google Design Sprint buat padetin journey dalam 3 minggu. Sketsa flow khusus buat produk wajah buat tes hipotesis AR.",
        image: "airy:layers",
      },
      {
        type: "ship",
        ...
        desc_id:
          "Dibangun pake Sketch dan Principle. Kami iterasi dua kali, tes usability ke 4 partisipan per iterasi buat poles interaksi AR.",
        image: "airy:ui",
      },
      {
        type: "measure",
        ...
        desc_id:
          "Partisipan suka interaksinya (engagement), tapi masih nanya soal akurasi warna. Kesimpulan: AR beresin soal 'Bentuk', tapi trust butuh validasi 'Tekstur'.",
        image: "airy:chart",
      },
    ],
    insights: [
    ...
    modules: [
      {
        ...
        content:
          "Participating in CHIuXID 2018 theme 'Designing for Intelligences'. Our SUX Team (Ifa, Kevin, Zaki) used a high-intensity Google Design Sprint to transform the 'social filter' behavior into a functional commerce tool called FilterMe.",
      },
      {
        title: "Closing the Trust Gap",
        content:
          "FilterMe changes the question from 'Is this product good?' to 'Is this product good *on me*?'. While we didn't win first place, the process taught us that fun and engagement are only the first steps toward building technical trust.",
      },
    ],
    modules_id: [
      {
        ...
        content:
          "Ikut CHIuXID 2018 tema 'Designing for Intelligences'. Tim SUX kami (Ifa, Kevin, Zaki) pake Google Design Sprint intensitas tinggi buat ubah perilaku 'filter sosial' jadi alat belanja fungsional bernama FilterMe.",
      },
      {
        title: "Menutup Celah Kepercayaan",
        content:
          "FilterMe ubah pertanyaan dari 'Produk ini bagus gak?' jadi 'Produk ini bagus gak *di saya*?'. Meski gak juara satu, prosesnya ngajarin kalau seru dan engagement baru langkah awal buat bangun trust teknis.",
      },
    ],
  },
];
