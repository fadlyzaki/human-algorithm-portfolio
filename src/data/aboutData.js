...
export const getStreaks = (t) => [
  {
    ...
    note: t("about.habit_consistency"),
...
export const creativeProcesses = [
  {
    name: "PIANO_DRIVER.EXE",
    icon: Headphones,
    url: "https://www.instagram.com/stories/highlights/18053183015382725/",
  },
  {
    name: "ANALOG_SKETCH",
    icon: PenLine,
    url: "https://www.instagram.com/stories/highlights/18100704214828888/",
  },
  {
    name: "DIGITAL_CANVAS",
    icon: PenTool,
