export const SIDE_PROJECTS = [
    ...
    },
    {
        ...
        subtitle: 'Human Algorithms',
        desc: 'Decoding the Gap Between Gamified Engagement and Cognitive Mastery.',
        tldr: "Gamification can mask a lack of progress. We redesigned learning to prioritize cognitive mastery over surface-level engagement.",
        tldr_id: "Gamifikasi dapat menutupi kurangnya kemajuan. Kami mendesain ulang pembelajaran untuk memprioritaskan penguasaan kognitif di atas keterlibatan permukaan.",
        ...
        challenge: "In the age of digital accessibility, why does academic performance often remain stagnant? Students at tutoring centers were experiencing 'cognitive burnout'. Mobile devices—which should be tools for high-efficiency learning—were primarily sources of passive distraction.",
        process: [
            {
        ...
        learnings: "By using data modeling to peel back the layers of user perception, we can design interfaces that don't just keep users engaged, but actually empower them to achieve mastery.",
        designProcess: [
            {
                type: "research",
        ...
        // ID Translations
        challenge_id: "Di era aksesibilitas digital, mengapa kinerja akademik seringkali stagnan? Perangkat seluler—yang seharusnya menjadi alat efisiensi tinggi—malah jadi sumber gangguan pasif.",
        process_id: [
            {
...
export const WORK_CLUSTERS = [
                ...
                caseStudy_id: {
                    ...
                    summaries: {
                        ...
                        recruiter: {
                            ...
                            text: "Merombak navigasi inti berdasarkan riset card-sorting. Mendatarkan hirarki dari 4 level jadi 2, meningkatkan retensi Hari-1 secara signifikan."
                        },
                        technical: {
                            label: "🤖 Sistem",
                    ...
                    process: [
                        { title: "Card Sorting", desc: "Saya lakukan card-sorting dengan user asli. Mental model mereka itu datar (flat), bukan hirarkis macam pohon.", image: "airy:hierarchy" },
                        { title: "Pilihan Sulit", desc: "Saya harus meyakinkan PM untuk membunuh fitur 'Advanced Search' kesayangan mereka. Kesederhanaan butuh pengorbanan.", image: "airy:funnel" }
                    ],
                    insights: [
                    ...
                    solution: [
                        { title: "Hirarki Datar", desc: "Saya pangkas kedalaman navigasi dari 4 level jadi 2. Setiap lowongan kerja kini bisa dijangkau dalam 2 tap.", image: "airy:layers" },
                        { title: "Tag Visual", desc: "Saya desain set ikon unik untuk setiap kategori pekerjaan, berfungsi sebagai jangkar visual saat scanning cepat.", image: "airy:ecosystem" }
                    ],
                    metrics: [
                    ...
                    aiHypotheses: [
                        {
                            ...
                            impact: "Waktu-Lamar Lebih Cepat"
                        },
                        {
                            tech: "Conversational AI & NLP",
    ...
    },
    {
        ...
        stats: [
            ...
            { label: 'Teams', value: 'Sales Force App, Logistics Dashboard, Warehouse Ops' },
