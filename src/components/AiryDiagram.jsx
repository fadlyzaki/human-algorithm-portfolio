    ...
    const renderDiagram = () => {
        switch (type) {
            ...
            case 'venn': // Intersection
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        <motion.circle cx="150" cy="150" r="80" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 1 }} />
                        <motion.circle cx="250" cy="150" r="80" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ x: 20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 1 }} />
                    ...
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        {[0, 1, 2].map(i => (
                            <React.Fragment key={i}>
                                ...
                                <motion.rect x={60 + i * 110} y="70" width="80" height="40" rx="2" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.5 + i * 0.2 }} />
                                {i === 1 && <motion.rect x={170} y="120" width="80" height="40" rx="2" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.9 }} />}
                            </React.Fragment>
                        ))}
                    </svg>
                );
            ...
            case 'chart': // Line Chart
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        ...
                        <motion.circle cx="350" cy="40" r="4" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: 1.5 }} />
                    </svg>
                );
            ...
            case 'radar': // Spider Chart
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        ...
                        <motion.path d="M 200 80 L 270 120 L 250 190 L 200 220 L 130 180 L 150 110 Z" fill="none" stroke={strokeColor} strokeWidth={strokeWidth * 1.5} initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} transition={{ duration: 1.5, delay: 0.5 }} />
            ...
            case 'ecosystem': // Concentric/Network
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        ...
                        <motion.circle cx="200" cy="150" r="80" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} strokeDasharray="4 4" initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 0.5, scale: 1 }} transition={{ duration: 1 }} />
            ...
            case 'funnel': // Funnel shape
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        ...
                        />
                        <motion.line x1="100" y1="120" x2="300" y2="120" stroke={strokeColor} strokeWidth={strokeWidth} strokeDasharray="4 4" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.5 }} />
                        <motion.line x1="150" y1="190" x2="250" y2="190" stroke={strokeColor} strokeWidth={strokeWidth} strokeDasharray="4 4" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 1.0 }} />
                        <motion.circle cx="200" cy="270" r="10" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 1.5 }} />
                    </svg>
                );
                ...
                return (
                    <svg viewBox="0 0 400 200" className="w-full h-full p-8">
                        ...
                        {[50, 150, 250, 350].map((x, i) => (
                            <React.Fragment key={i}>
                                <motion.circle cx={x} cy="100" r="6" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: i * 0.2 }} />
            ...
            case 'architecture': // Isometric blocks
                return (
                    <svg viewBox="0 0 400 300" className="w-full h-full p-8">
                        <motion.path d="M 100 200 L 200 250 L 300 200 L 200 150 Z" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} />
                        <motion.path d="M 100 140 L 200 190 L 300 140 L 200 90 Z" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} />
                        <motion.path d="M 100 80 L 200 130 L 300 80 L 200 30 Z" fill="none" stroke={strokeColor} strokeWidth={strokeWidth} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} />
