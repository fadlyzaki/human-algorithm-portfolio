...
const AiryDiagram = ({ type = "flow", className = "" }) => {
  ...
  const DiagramComponent =
    DIAGRAM_REGISTRY[type] || DIAGRAM_REGISTRY["default"];

  return (
    <div
      className={`w-full h-full flex items-center justify-center opacity-70 ${className} text-gray-500 dark:text-gray-400`}
    >
