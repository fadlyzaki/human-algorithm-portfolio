                ...
                ? {
                    ...
                    filter:
                      hoveredIndex === i
                        ...
                        : hoveredIndex !== null
                          ? "grayscale(80%) brightness(50%) blur(1px)"
                          : "grayscale(0%) brightness(100%) blur(0px)",
        ...
        >
          <ScrollReveal delay={300} className="h-full block">
            ...
            >
              <Archive
                size={48}
                className={`text-[var(--text-primary)] mb-6 transition-colors ${hoveredIndex === 3 ? "text-[var(--accent-blue)]" : ""}`}
              />
              <h3
                className={`text-3xl font-serif italic text-[var(--text-primary)] mb-4 transition-colors ${hoveredIndex === 3 ? "text-[var(--accent-blue)]" : ""}`}
              >
                {t("home.archive_title") || "View All Ventures"}
              </h3>
              <p
                className={`text-[var(--text-secondary)] text-base max-w-xs font-light mb-8 transition-opacity duration-300 ${hoveredIndex !== null && hoveredIndex !== 3 ? "opacity-0" : "opacity-100"}`}
              >
                {t("home.archive_desc") ||
                  "Explore all experiments, products, and interactive prototypes."}
              </p>
              <div
