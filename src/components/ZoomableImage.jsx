...
const ZoomableImage = ({
  ...
  if (hasError) {
    return (
      <div
        className={`flex flex-col items-center justify-center bg-[var(--bg-card)] border border-[var(--border-color)] p-8 rounded-lg opacity-50 ${containerClassName} ${className}`}
