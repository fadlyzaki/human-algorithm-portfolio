    ...
    >
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="rounded-2xl border border-[var(--border-color)] bg-[var(--bg-void)] overflow-hidden shadow-2xl flex flex-col min-h-[85vh]">
          ...
          <div className="h-6 bg-[#007acc] dark:bg-[var(--accent-purple)] text-white flex items-center justify-between px-4 text-[9px] font-mono uppercase tracking-wider shrink-0">
