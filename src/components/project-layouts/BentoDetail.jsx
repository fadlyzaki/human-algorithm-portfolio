            ...
            {activeMetrics && (
              <div className="grid grid-cols-2 gap-6 h-full min-h-[300px]">
                {activeMetrics.map((m, i) => (
                  <div
                    key={i}
                    className="bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-[2rem] p-8 flex flex-col justify-center h-full w-full"
                  >
