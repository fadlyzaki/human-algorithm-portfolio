            ...
            {activeInsights?.[0]?.image && (
              <div className="border-4 border-[var(--text-primary)] p-4 h-[400px] bg-[var(--bg-surface)] overflow-hidden">
                {activeInsights[0].image.startsWith("airy:") ? (
                  ...
                  <ZoomableImage
                    src={activeInsights[0].image}
                    alt="Data"
                    className="w-full h-full object-cover grayscale mix-blend-multiply dark:mix-blend-screen"
                  />
                )}
              </div>
            )}
                ...
                {activeProcess.map((step, idx) => (
                  ...
                  >
                    ...
                    <div className="p-8 flex-1 flex flex-col">
                      ...
                      <p className="text-lg font-medium leading-snug mt-auto">
                        {step.desc}
                      </p>
                    </div>
                  </article>
              ...
              {activeMetrics && (
                <div className="space-y-8 lg:col-span-1">
                  ...
                  {activeMetrics.map((m, i) => (
                    <div
                      key={i}
                      className="bg-[var(--text-primary)] text-[var(--bg-void)] p-6"
                    >
                      <div className="text-5xl font-black tracking-tighter mb-2">
                        {m.value}
                      </div>
                      <div className="font-mono text-sm uppercase font-bold">
                        {m.label}
                      </div>
                    </div>
                  ))}
