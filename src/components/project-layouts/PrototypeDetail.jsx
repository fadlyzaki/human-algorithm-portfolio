...
const PrototypeDetail = ({
  ...
  return (
    <div
      ref={containerRef}
      className="bg-[var(--bg-void)] text-[var(--text-primary)] font-sans min-h-screen selection:bg-[var(--accent)] selection:text-white pb-32 relative overflow-hidden"
              ...
              <section>
                ...
                <div className="space-y-24">
                  {activeProcess.map((step, idx) => (
                    <div
                      key={idx}
                      className="group flex flex-col md:flex-row gap-8 lg:gap-12"
                    >
