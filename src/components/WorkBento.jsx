    ...
    return (
        ...
        >
            ...
            <div className="relative flex-grow w-full overflow-hidden flex items-end justify-center px-8 pb-0 mt-4 z-10">
                ...
                {/* Device / Visual Frame */}
                <div className={`relative transform transition-transform duration-700 group-hover:scale-105 group-hover:-translate-y-2 origin-bottom ${cluster.heroImage && cluster.heroImage.startsWith('/') ? 'w-[180px] mx-auto' : 'w-full max-w-[90%]'}`}>
