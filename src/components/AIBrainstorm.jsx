        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          {hypotheses.length > 1 && (
            <span className="font-mono text-xs text-gray-600">
              {t("protected.idea") || "Idea"} {currentIndex + 1}{" "}
              {t("protected.of") || "of"} {hypotheses.length}
            </span>
          )}
        </div>
          ...
          >
            <div className="max-w-md">
              <div className="flex items-center justify-end gap-2 mb-2">
                <span className="font-mono text-xs text-amber-400/70 uppercase tracking-wider">
                  {t("protected.human_label") || "You"}
                </span>
            ...
            <div className="max-w-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-mono text-xs text-emerald-400/70 uppercase tracking-wider">
                  {t("protected.ai_label") || "AI Collaborator"}
                </span>
              </div>
                ...
                {isThinking ? (
                  <div className="py-2">
                    ...
                    <p className="text-gray-500 text-xs mt-2 font-mono">
                      {t("protected.exploring") || "Exploring alternatives..."}
                    </p>
                  </div>
                ) : (
                  <p className="text-gray-300 text-sm leading-relaxed">
                    {t("protected.ai_response") ||
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-gradient-to-br from-emerald-400 to-cyan-500 rounded-xl px-4 py-3 text-center">
                        <div className="text-xs font-mono text-black/70 uppercase tracking-wider mb-1">
                          {t("protected.impact_label") || "Impact"}
                        </div>
                  ...
                  {hypotheses.length > 1 && (
                    ...
                    >
                      <span className="font-mono text-xs uppercase tracking-wider">
                        {isThinking
                          ? t("protected.exploring") || "Thinking..."
                          : t("protected.explore_another") ||
