...
const StatusBar = ({ variant = "dark" }) => {
  ...
  return (
    <div
      className={`w-full px-4 py-2 flex justify-between items-center ${textColor} text-xs font-medium z-50`}
    >
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden mb-4 border border-gray-100 dark:border-gray-700">
      <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-start">
        ...
        <span
          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold ${statusColorClass} ${statusTextClass}`}
        >
          {status}
        </span>
      </div>
      ...
      {alertMessage && (
        <div
          className={`px-4 py-3 border-l-4 text-xs ${alertStyles[alertType] || alertStyles.info} flex gap-2 items-start`}
        >
  ...
  return (
    <div className="relative w-full h-full flex flex-col bg-black font-sans">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80')",
        }}
      >
      ...
      <div className="relative z-10 w-full h-full flex flex-col pt-12 px-2">
        ...
        {/* Notification Card */}
        <button
          onClick={() => onNavigate("details-processing")}
          className="block transform transition hover:scale-[1.02] active:scale-95 text-left w-full"
        >
...
const DetailsProcessing = ({ onNavigate }) => {
  return (
    <OrderDetailsLayout
      ...
      activeScreen="details-processing"
    >
      <OrderSection
        ...
        alertMessage={
          <span>
            Pesanan sedang diproses dan tiba besok sekitar jam{" "}
            <span className="font-bold">05:00 - 06:30</span>
          </span>
        }
        alertType="info"
        items={[
  ...
  return (
    <OrderDetailsLayout onNavigate={onNavigate} activeScreen="details-ready">
      <OrderSection
        ...
        alertMessage={
          <span>
            Pesanan siap diantarkan dan tiba sekitar jam{" "}
            <span className="font-bold">05:00 - 06:30</span>
          </span>
        }
        alertType="warning"
  ...
  return (
    <OrderDetailsLayout onNavigate={onNavigate} activeScreen="details-ontheway">
      ...
      <OrderSection
        ...
        alertMessage={
          <span>
            Pesanan sedang diproses dan tiba sekitar jam{" "}
  ...
  return (
    <OrderDetailsLayout onNavigate={onNavigate} activeScreen="details-delayed">
      <OrderSection
        ...
        alertMessage={
          <span>
            Mohon maaf, pengiriman ini diperkirakan akan tiba pada jam{" "}
...
const DetailsDelivered = ({ onNavigate }) => {
  return (
    <OrderDetailsLayout
      onNavigate={onNavigate}
      activeScreen="details-delivered"
    >
      <OrderSection
        title="Pengiriman Produk Segar"
        status="Sudah Sampai"
