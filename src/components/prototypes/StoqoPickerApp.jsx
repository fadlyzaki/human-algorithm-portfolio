        ...
        <div className="bg-white dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700 opacity-60">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 line-through">
                  Gulaku Kuning (1kg)
                </h3>
        ...
        {items
          ...
          .map((item, idx) => (
            ...
            >
              ...
              {idx === 0 && (
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#f27f0d]"></div>
              )}
              ...
              <div className="flex justify-between items-start w-full">
                ...
                <div className="text-right">
                  <span className="text-lg font-bold text-[#f27f0d]">
                    {item.qty}
                  </span>
                  <span className="text-[10px] block text-gray-500 uppercase">
                    {item.unit}
                  </span>
                </div>
              </div>
              ...
              <div className="w-full pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
                ...
                <ChevronRight
                  size={16}
                  className="text-gray-400 group-hover:text-[#f27f0d] transition-colors"
                />
              </div>
            </button>
          ))}
      ...
      <div className="absolute inset-0 flex flex-col justify-between z-20">
        <div className="p-4 pt-12 flex justify-between items-center">
          <button
            ...
            className="w-8 h-8 rounded-full bg-black/40 text-white flex items-center justify-center backdrop-blur-md"
          >
            <X size={18} />
          </button>
      ...
      <div className="flex-1 p-6 flex flex-col items-center pt-12">
        ...
        <div className="w-full bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4">
          ...
          <div className="flex items-center justify-between">
            <button className="w-10 h-10 rounded bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-bold text-xl flex items-center justify-center">
              -
            </button>
