...
const SearchScreen = ({ flight, setScreen }) => (
  <div className="bg-gray-50 h-full pb-14 overflow-y-auto">
    <Header title="Jakarta to Bali" showBack={false} setScreen={setScreen} />
    ...
    <div className="bg-white p-2 flex overflow-x-auto space-x-2 shadow-sm mb-3">
      {["Today", "Tomorrow", "Wed, 24", "Thu, 25"].map((d, i) => (
        <div
          key={i}
          className={`flex-shrink-0 px-3 py-1.5 rounded-full text-[11px] font-medium ${i === 1 ? "bg-blue-100 text-blue-700 border border-blue-200" : "text-gray-500 border border-gray-200"}`}
        >
          {d}
        </div>
      ))}
    ...
    <div className="px-3 space-y-3">
        ...
        <div className="p-3">
          <div className="flex justify-between items-start mb-3">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-blue-900 rounded-full flex items-center justify-center text-white text-[10px] font-bold">
                GA
              </div>
              <div>
          ...
          <div className="flex justify-between items-center mb-3 text-xs text-gray-600 bg-gray-50 p-2 rounded-lg">
            ...
            <div className="flex flex-col items-center px-3 w-full">
              ...
              <div className="w-full h-[1px] bg-gray-300 relative my-1">
                <Plane
                  size={10}
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-gray-400 bg-gray-50 p-[1px]"
                />
              </div>
            </div>
            <div className="text-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-[9px] text-blue-700">
                  Freeze this price for 24h. No commitment.
                </p>
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 opacity-70">
        ...
        <div className="text-[10px] text-gray-400">
          Price Lock unavailable for this flight
        </div>
      </div>
    </div>
  </div>
...
const LockModal = ({ flight, setScreen, handleLock }) => (
      ...
      <div className="bg-blue-600 p-3 text-white flex justify-between items-start">
        <div>
          ...
          <p className="text-[10px] text-blue-100 mt-0.5">
            Don't let the price jump while you decide.
          </p>
        </div>
        <button
          onClick={() => setScreen("search")}
      ...
      <div className="p-4">
        ...
        <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-2.5 mb-4 flex gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-yellow-700 mt-0.5 leading-relaxed">
              We detect high demand for this route. Prices are{" "}
              <strong>85% likely to increase</strong> by tomorrow.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg border border-gray-200 mb-4">
          ...
          <p className="text-sm font-bold text-gray-800">
            Rp {flight.lockFee.toLocaleString()}
          </p>
        </div>
...
const SuccessScreen = ({ timeLeft, formatTime, setScreen }) => (
  <div className="h-full bg-blue-600 flex flex-col items-center justify-center p-4 text-white text-center">
    ...
    <p className="text-blue-100 mb-6 max-w-[240px] text-xs">
      You have secured the price of <strong>Rp 1.500.000</strong> for the next
      24 hours.
    </p>
...
const BookingsScreen = ({ lockedItem, timeLeft, formatTime, setScreen }) => (
  <div className="bg-gray-50 h-full pb-14 overflow-y-auto">
    <Header title="My Trips" showBack={false} setScreen={setScreen} />

    <div className="p-3">
      {/* Tabs */}
      <div className="flex mb-4 border-b border-gray-200">
        <button className="flex-1 pb-2 text-[11px] font-bold text-blue-600 border-b-2 border-blue-600">
          Saved & Locked
        </button>
        <button className="flex-1 pb-2 text-[11px] font-medium text-gray-400">
          Upcoming
        </button>
        <button className="flex-1 pb-2 text-[11px] font-medium text-gray-400">
          Past
        ...
        <div className="bg-white rounded-xl shadow-md border border-blue-100 overflow-hidden">
          ...
          <div className="p-3">
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-[11px] text-gray-500">
                  {lockedItem.airline} • {lockedItem.code}
                </p>
              </div>
              <div className="text-right">
            ...
            <div className="bg-blue-50 text-blue-800 text-[10px] p-2.5 rounded-lg mb-3 flex gap-1.5 items-start">
              ...
              <p>
                Current market price has risen to Rp 1.850.000. You saved Rp
                350.000 by locking!
              </p>
            </div>
    ...
    <BottomNav screen="bookings" setScreen={setScreen} />
  </div>
);
