...
const FloodAlert = () => {
  ...
  return (
    <div
      className="flex justify-center font-sans antialiased rounded-xl overflow-hidden"
      ...
      <div className="relative w-full max-w-sm bg-slate-950 h-[600px] flex flex-col overflow-hidden">
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full">
            ...
            {/* Flood Zone 1 */}
            <path
              d="M 176 120 Q 224 96 280 144 T 256 240 L 200 224 Z"
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            <div
              className="absolute -inset-6 bg-blue-500/20 rounded-full animate-ping"
              style={{ animationDuration: "2s" }}
            />
            <div className="w-5 h-5 bg-blue-500 rounded-full border-2 border-white shadow-xl" />
            <div className="absolute top-6 left-1/2 -translate-x-1/2 bg-white px-2 py-0.5 rounded shadow text-[9px] font-bold whitespace-nowrap text-blue-600">
              LOKASI KAMU
            </div>
          </div>
          ...
          <div className="absolute top-10 left-3 right-3 z-40 space-y-2">
            <div className="bg-slate-900/90 backdrop-blur-md border border-white/10 p-2.5 rounded-2xl flex items-center gap-2.5">
              ...
              <p className="text-white text-[11px] font-semibold">
                Lokasi: <span className="text-slate-400">Padang, Sumbar</span>
              </p>
            </div>
          </div>
          ...
          <div className="absolute top-[72px] left-3 right-3 z-40 animate-pulse">
            <div className="bg-orange-500/90 backdrop-blur-sm p-2.5 rounded-2xl border border-white/20 flex items-center gap-2.5 shadow-lg">
              ...
              <p className="text-white font-bold text-[10px] leading-tight">
                Waspada hujan lebat di pesisir Pantai Padang!
              </p>
            </div>
          </div>
        </div>
        ...
        >
              ...
              <div className="flex justify-between items-end mb-4">
                <div>
                  ...
                  <p className="text-slate-400 text-[10px]">
                    Cari jalan aman dari banjir hari ini.
                  </p>
                </div>
          ...
          {view === "detail" && (
            <div className="animate-in fade-in duration-300">
              <button
                onClick={tutupInfo}
                className="mb-2 flex items-center gap-1 text-slate-500 text-[11px] hover:text-slate-300 transition-colors"
              >
                <ChevronLeft className="w-3 h-3" /> Balik ke Peta
              </button>
              <div className="flex justify-between items-center mb-3">
                <h3 className="text-base font-bold text-white">{infoNama}</h3>
                <span className="bg-blue-600 text-[9px] font-bold px-2 py-1 rounded-md text-white">
                  {infoJarak}
                </span>
              </div>
              <div className="flex gap-2 mb-4">
                <div className="flex-1 bg-slate-800/50 p-2.5 rounded-xl border border-white/5">
                  <p className="text-[8px] text-slate-500 uppercase font-bold mb-0.5">
                    Status
                  </p>
