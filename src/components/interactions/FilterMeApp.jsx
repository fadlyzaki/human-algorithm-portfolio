    ...
    const RenderMap = {
      ...
      glasses: () => (
        <div className="absolute top-[35%] left-1/2 -translate-x-1/2 w-[70%] animate-in fade-in duration-500 z-20 pointer-events-none">
          ...
          >
            <path
              d="M10 20 C 10 20, 30 10, 50 10 C 70 10, 90 20, 90 40 C 90 60, 70 70, 50 70 C 30 70, 10 60, 10 40 Z"
              fill="black"
              fillOpacity="0.8"
            />
            <path
              d="M110 20 C 110 20, 130 10, 150 10 C 170 10, 190 20, 190 40 C 190 60, 170 70, 150 70 C 130 70, 110 60, 110 40 Z"
              fill="black"
              fillOpacity="0.8"
            />
            <path
              d="M90 30 Q 100 20 110 30"
              stroke="gold"
              strokeWidth="3"
              fill="none"
            />
    ...
    <div className="flex items-center justify-center min-h-[740px] bg-gray-100 p-4 font-sans text-gray-900">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 no-scrollbar">
              {cart.length === 0 ? (
                ...
                cart.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex gap-4 p-3 border rounded-xl shadow-sm"
                  >
              ...
              {!cameraRequested ? (
                ...
                <div className="text-white text-center p-8">
                  ...
                  <p className="text-sm text-gray-400">
                    Since this is a prototype, please allow camera access or
                    view in a secure context.
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-48 h-64 border-2 border-dashed border-white/30 rounded-[50%] pointer-events-none opacity-50 flex items-center justify-center">
                    <span className="text-white/50 text-xs font-bold bg-black/20 px-2 py-1 rounded">
                      Align Face Here
                    </span>
                  </div>
      ...
      <div className="hidden lg:block absolute left-12 top-1/2 -translate-y-1/2 max-w-sm text-gray-600 text-left">
        ...
        <p className="mb-8 text-xl leading-relaxed font-medium">
          The 2018 concept re-imagined. Bridging the gap between social stories
          and e-commerce through intelligent AR try-ons.
        </p>
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 shrink-0 rounded-full bg-black text-white flex items-center justify-center">
              <Sparkles size={18} />
            </div>
            <div>
              ...
              <p className="text-sm">
                Solving the "can't touch/feel" problem of online shopping.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm">
                Utilizing the familiar "Stories" UI for Millennial shoppers.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm">
                Seamless add-to-cart directly from the try-on experience.
              </p>
            </div>
          </div>
        </div>
