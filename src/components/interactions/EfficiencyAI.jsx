...
const EfficiencyAI = ({ color = "#FA6130" }) => {
  ...
  return (
    <div className="w-full h-full min-h-[400px] relative overflow-x-auto overflow-y-hidden custom-scrollbar bg-black/5 rounded-xl border border-white/10 backdrop-blur-sm font-mono select-none">
      <div className="min-w-[700px] w-full h-full p-4 md:p-8 flex items-center justify-center relative">
        {/* Background Texture */}
        <div
          ...
          <div className="relative z-10 flex flex-col items-center justify-center">
            ...
            <div className="w-24 h-24 bg-black/50 backdrop-blur-xl rounded-full border border-white/10 flex items-center justify-center shadow-[0_0_50px_rgba(250,97,48,0.1)] relative group">
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[8px] font-mono text-[var(--brand)] tracking-widest mt-1">
                  JIT_SYNC
                </span>
