                ...
                <div className="flex gap-4">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="flex flex-col items-center gap-4">
                            ...
                            <div className={`w-16 h-10 border border-slate-100 dark:border-white/10 bg-white dark:bg-white/5 rounded-lg animate-[pulse_${2 + i}s_ease-in-out_infinite]`}></div>
                        </div>
                    ))}
                </div>
            </div>
