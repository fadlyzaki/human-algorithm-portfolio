...
const ProjectKinshipCard = ({ expanded, showChrome }) => (
  <Container
    ...
    figIndex="1.2"
    schematicType="SOCIAL_LOGISTICS_PATH"
  >
    <div className="w-full h-full p-12">
      <svg className="w-full h-full" viewBox="0 0 100 60">
        ...
        <circle
          ...
          cy="40"
          r="4"
          className="fill-[var(--brand)] opacity-20 animate-pulse"
        />
        <circle
          cx="90"
          cy="10"
          r="4"
          className="fill-[var(--brand)] animate-pulse"
        />
      ...
      <div className="absolute bottom-10 right-10 w-48 bg-white border border-slate-100 rounded-lg p-4 shadow-[0_10px_40px_rgba(var(--bg-void-rgb), 0.06)] flex flex-col gap-2.5 animate-[bounce_6s_ease-in-out_infinite]">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[8px] uppercase tracking-wider text-orange-500 font-bold">
            LAST_MILE_NODE
          </span>
        </div>
