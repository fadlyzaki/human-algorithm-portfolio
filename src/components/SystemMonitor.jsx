...
const SystemMonitor = ({ skills }) => {
    ...
    return (
        <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg p-6 font-mono text-xs shadow-xl backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {skills.map((skill, idx) => (
                    <div key={idx} className="space-y-2 group">
                        ...
                        {/* Sub-process */}
                        <div className="text-[9px] text-[var(--text-secondary)] opacity-50 uppercase tracking-wider flex justify-between">
            ...
            {/* Decorative Footer */}
            <div className="mt-8 pt-4 border-t border-[var(--border-color)] border-dashed flex justify-between opacity-50">
